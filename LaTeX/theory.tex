...
linearly. This is proven by the description of the algorithm, there are $p-1$
...
\begin{mdframed}
  \begin{center}
    ...
    odd numbers. Assuming that $p$ is a composite, it must have at least 2
...
whole concept is based on Fermat's little theory \cite{fermat:little} which
states:
